...
<script>
  ...
  export default {
    ...
    data(){
      return{
        list: [messageList],
        qiCaiYunAvatar: '/static/images/avatar.png',
        submitMessage: '',
        userMessage:true
      }
    },
...
<style scoped lang="less">
  .messageBoard{
    background: url("/static/images/messageBoard_background.png") no-repeat center center;
    ...
    .submit{
      ...
      .submit-button{
        margin-left: .1rem;
        background: url("/static/images/message_submit.png") no-repeat center center;
