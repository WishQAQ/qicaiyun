  ...
  export default {
    data() {
      return {
        ...
        prize_list: [
          {
            icon: "/static/img/bean_500.png", // 奖品图片
            count: 10, // 奖品数量
            name: "易趣豆", // 奖品名称
            isPrize: 1 // 该奖项是否为奖品
          },
          {
            icon: "/static/img/bean_five.png",
            count: 5,
            name: "豆",
            isPrize: 1
          },
          {
            icon: "/static/img/bean_one.png",
            count: 10,
            name: "易趣豆",
            isPrize: 1
          },
          {
            icon: "/static/img/point_five.png",
            count: 5,
            name: "积分",
            isPrize: 1
          },
          {
            icon: "/static/img/point_ten.png",
            count: 10,
            name: "积分",
            isPrize: 1
          },
          {
            icon: "/static/img/bean_500.png",
            count: 10,
            name: "易趣豆",
            isPrize: 1
          },
          {
            icon: "/static/img/give_up.png",
            count: 0,
            name: "未中奖",
            isPrize: 0
          },
